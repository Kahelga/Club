...
import com.example.club.authorization.ProfileRoute
...
import com.example.club.authorization.ui.ProfileScreen
    ...
    Surface {
        NavHost(navController = navController, startDestination = PosterRoute) {
            ...
            composable<AuthRoute>{
                ...
                AuthScreen(
                    authViewModel,
                    onLoginSuccess= { navController.navigate(ProfileRoute)},
                    onBackPressed = { navController.popBackStack() }
                )
            }
